...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['benstone22/GameAIFinal','samuel-barnett/GPR300FINAL'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  resume: {
    fileUrl:
      'https://benstone22.github.io/Ben_Stone_Resume_2026.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'C++',
    'Unity 2D/3D C#',
